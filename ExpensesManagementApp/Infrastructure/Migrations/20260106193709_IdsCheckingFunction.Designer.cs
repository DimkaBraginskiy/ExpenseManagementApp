...
namespace ExpensesManagementApp.Migrations
{
    ...
    [Migration("20260106193709_IdsCheckingFunction")]
    partial class IdsCheckingFunction
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ExpensesManagementApp.Models.Expense", b =>
                {
                    ...
                    b.ToTable("Expense", t =>
                        {
                            t.HasCheckConstraint("CK_Expense_Owner_Exclusive", "(\"UserId\" IS NOT NULL AND \"GuestSessionId\" IS NULL) OR (\"UserId\" IS NULL AND \"GuestSessionId\" IS NOT NULL)");
                        });
                });
